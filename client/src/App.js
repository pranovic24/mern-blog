      ...
      <div className="post">
        ...
        <div className="texts">
          ...
          <p className="summary">
            ...
            labore inventore placeat deserunt repellat provident praesentium
            unde, quos officia aliquid officiis eveniet voluptates voluptas
            corrupti iusto! Qui, dolorem molestiae!
          </p>
        </div>
      </div>
